...
// CODE HERE
const totalPopulation  = populations.reduce((accu,popu)=>accu+popu)
...
let totalOrders = orders.map((order)=>order.price*order.tax)
...
let bobsTotal = purchases.filter((obj)=>obj.owner==="Bob").reduce((accu,obj)=>accu+obj.price,0)